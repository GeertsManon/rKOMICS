#' Cluster Analyses
#'
#' The msc.uc function allows you to process VSEARCH clustering results and inspect the numbers of MSC's,the number of perfect alignments and the number of 2-nt and 3-nt gaps per minimum percent identity.
#' @usage msc.uc(files)
